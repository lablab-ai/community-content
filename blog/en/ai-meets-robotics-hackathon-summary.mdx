...
After a rigorous judging process focusing on innovation, technical depth, and market potential, the following projects were recognized for their excellence.

### **Main Hackathon Winners**

*   **Ladybug - The Robot Reader** (Team: Ladybug)
*   **CarphaCom - Robotised E-commerce** (Team: Cybertron)
*   **Data infrastructure for Real World Robot Training** (Team: Ooju)
*   **Tattle Turtle** (Team: Kernel Forge)
*   **GoferAI - Semantic VLA RAG Layer** (Team: Gofer AI)
*   **DroneOS - AI-Powered Autonomous Fleet Dispatch** (Team: Aeris Robotics)
*   **Sleepy Mini** (Team: Max Health)
*   **Piythia** (Team: Piythia)
*   **Sovereign AI Robotics Ops** (Team: Sovereign AI Labs)
*   **RoboBazaar** (Team: RoboBazaar)

### **Notable Finalists**

The competition was incredibly tight, with these projects also making a significant impact:

*   **Valentimer** (Team: Valentimer)
*   **SweetyAI** (Team: SweetyAI)
*   **MIRRORBOT** (Team: MIRRORBOT)
*   **AgroMind - Autonomous Swarm vs Locust Plague** (Team: Argentum Robotics)
*   **ARCC The Universal AI Logistics OS** (Team: Eternea)
*   **Nexora** (Team: Nexora AI)
*   **SkyMind AI** (Team: SkyMind AI)
