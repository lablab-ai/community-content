...
### [Text embedder with Cohere](https://lablab.ai/ai-tutorials/cohere-text-embedder)
...
### [Build a product description generator API with cohere](https://lablab.ai/ai-tutorials/cohere-product-description-generator)
...
### [Text classifier with Cohere](https://lablab.ai/ai-tutorials/cohere-text-classifier)
...
[Enroll now!](https://lablab.ai/ai-hackathons/cohere-thanksgiving-hackathon)
