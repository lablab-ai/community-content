...
Last month we published a dedicated article for 30 000 lablab.ai community participants and now we are more than happy to publish another one - announcing that over 40 000 amazing builders, creators and innovators from all around the world took part in lablab.ai [AI Hackathons](https://lablab.ai/ai-hackathons)!
...
That’s why we launched some features to help you all learn more, grow faster and assist your project all the way to working startup. You can read about all the new features on our [AI blog](https://lablab.ai/ai-articles/were-growing-with-our-community-new-features-on-lablabai). But we encourage you to:
...
There are thousands of us and even more to come! We encourage you to engage within the community by participating in amazing AI Hackathons, using cutting edge AI technology, like [ChatGPT api](https://lablab.ai/ai-hackathons/chatgpt-api-and-whisper-api-global-hackathon) or in the second edition of a dedicated event to help you build your [AI startup](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2)! Or you can get involved more into the AI community, shape the landscape of AI technology by writing dedicated tutorials or blog articles for lablab.ai to help others grow.
