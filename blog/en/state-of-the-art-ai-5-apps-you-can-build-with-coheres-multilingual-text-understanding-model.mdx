---
title: "5 AI APPS you can build with Cohere’s Multilingual Text Understanding Model"
...
You can also try the model out during our [AI Hackathons](https://lablab.ai/ai-hackathons)! Sign up to our events and with a group of like-minded people from around the world create a working model which can be the first step in founding your own startup! Learn, grow and innovate with lablab.ai! 
