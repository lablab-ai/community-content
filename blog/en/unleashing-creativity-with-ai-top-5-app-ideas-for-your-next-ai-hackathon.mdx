...
Join our upcoming [Hackathon artificial intelligence](https://lablab.ai/ai-hackathons) and join an amazing community of future leaders from all around the world. During our most recent [OpenAI Hackathon](https://lablab.ai/ai-hackathons/openai-hackathon) we had over 7000 participants! Let’s break this record and change the reality with AI!
