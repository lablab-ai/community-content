...
None of this would have been possible without the invaluable support of lablab.ai's mentors and the treasure trove of [AI21 tutorials](https://lablab.ai/ai-tutorials/tech/ai21-labs) available online, including resources on [ChatGPT API](https://lablab.ai/tech/openai/chatgpt) and [generative AI models](https://lablab.ai/ai-articles/generative-ai-generative-ai-models).
...
An outstanding chrome extension [Catch Me Up](https://lablab.ai/ai-hackathons/ai21-labs-hackathon-2/reluvape/catch-me-upYou2:37) won first place, by wowing the judges. But let’s know more about this tool, that uses speech-to-text technology.
...
During the second AI21 labs Hackathon was also created a medical chatbot app - cheers to [Dr.Chat](https://lablab.ai/ai-hackathons/ai21-labs-hackathon-2/dr-chat/dr-chat)! This tool connects patients with doctors in a seamless and intuitive way!
...
[Groove AI](https://lablab.ai/ai-hackathons/ai21-labs-hackathon-2/wizards/groove-ai) is an app, which is going to revolutionize the way we experience music!
...
Imagine the possibilities — these passionate minds created working apps in just 7 days! What could they achieve in 3 months with a startup? Perhaps they'll join New Native's [AI Slingshot](https://lablab.ai/ai-articles/giving-voice-to-the-community-new-features-on-lablabai) program and continue to refine their innovative ideas with the support of lablab.ai! 

Don't miss out on this AI revolution! Join our [Artificial Intelligence Hackathon](https://lablab.ai/ai-hackathons) and be one of the constructors of changing world! Connect with other like-minded individuals and contribute to shaping the future of AI. 
