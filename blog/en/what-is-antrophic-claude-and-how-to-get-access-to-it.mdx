...
In order to join [Anthropic Hackathon](https://lablab.ai/ai-hackathons/anthropic-ai-hackathon) and build an amazing [Anthropic application](https://lablab.ai/apps/tech/anthropic/claude) you need an [Antrohpic API](https://lablab.ai/tech/anthropic/claude) key. And that’s why Anthropic decided to give API to all of lablab.ai community members for the duration of the Hack! 
