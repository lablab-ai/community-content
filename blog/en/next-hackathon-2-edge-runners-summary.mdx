...
⭐ [SafeEdge](https://lablab.ai/ai-hackathons/next2-edge-runners/morpheus/safeedge-online-education-inclusive-and-enjoyable) - is an AI content moderation tool for educational platforms, working offline on edge devices. It uses advanced models, synthetic data, and local deployment, ensuring privacy and real-time filtering.

⭐ [DefendX](https://lablab.ai/ai-hackathons/next2-edge-runners/cipher-watch/defendx) - is an AI cybersecurity solution for edge devices, detecting threats like abnormal logins and malware. Using Llama, Phi3, and Streamlit, it offers real-time detection, analysis, and user-friendly monitoring.

⭐ [Compass AI](https://lablab.ai/ai-hackathons/next2-edge-runners/compass-ai/compass-ai) - creates personalized marketing strategies with just a few inputs, generating content and auto-publishing on social media. It saves time, reduces costs, and boosts engagement using AI automation.
