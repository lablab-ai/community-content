...
[Team Kairos](https://lablab.ai/blog/the-kairos-story-at-raise) won the Qubic track with QBuild, a one-click auditing tool that identifies vulnerabilities, generates reports, and creates test sets for smart contracts. [Project link](https://lablab.ai/event/raise-your-hack/kairos-qubic-track/qbuild-audit-and-test-tool-for-qubic-sc)
