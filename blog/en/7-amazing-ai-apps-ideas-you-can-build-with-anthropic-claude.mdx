...
Everyone can sign in to a waitlist in order to build with[ Anthropic API](https://lablab.ai/tech/anthropic/claude), but members of lablab.ai community have an additional option - [see our previous blog](https://lablab.ai/ai-articles/what-is-antrophic-claude-and-how-to-get-access-to-it#how-to-get-anthropic-claude-before-everyone) post about it.
...
… as lablab.ai partnered with Anthropic for [Anthropic Hackathon](https://lablab.ai/ai-hackathons/anthropic-ai-hackathon) in order to allow our amazing community of AI builders to create unique Anthropic applications before everyone else, they are giving API access to every team participating in our Hack!!
