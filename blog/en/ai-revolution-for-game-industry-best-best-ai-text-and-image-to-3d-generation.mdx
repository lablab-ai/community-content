---
title: "AI revolution for game industry: Best AI text-to-3D generation AI tools"
...
You can use [AutoGPT API](https://lablab.ai/tech/autogpt) for your project or as previously mentioned, use any of the [ChatGPT apps](https://lablab.ai/apps/tech/openai/chatgpt) - the choice is yours. And if you can’t find an app which fits your needs, why not build one during an [Artificial Intelligence Hackathon](https://lablab.ai/ai-hackathons)? We have plenty of them on lablab and during each of them, you can with other like-minded people build it in 2 or 7 days!
