---
title: "From Hackathon to Reality: How Builders Are Using Arc for Agentic Commerce"
description: "Discover how 1,200+ builders at the Agentic Commerce on Arc hackathon are turning autonomous AI finance into production-ready systems using Arc L1, Circle's USDC infrastructure, and the x402 protocol."
...
> **Note:** To stay connected with Arc builders and upcoming events, consider joining [Arc's Community Hub](https://arc.network/community).
...
All submissions from the hackathon are now live. Explore them here: [Agentic Commerce on Arc projects](https://lablab.ai/ai-hackathons/agentic-commerce-on-arc/projects), and check out more [global AI hackathons](https://lablab.ai/ai-hackathons) on [LabLab.ai](https://lablab.ai) if you're ready to build your next AI hackathon project. To stay connected with Arc builders and upcoming events, consider joining [Arc's Community Hub](https://arc.network/community).
