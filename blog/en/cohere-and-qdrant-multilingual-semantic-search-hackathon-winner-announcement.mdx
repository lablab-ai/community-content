...
[Categories:](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon#:~:text=Categories%3A,purchase%20or%20see)
...
And last, and not least, the important thing is that, for the first time, we invited a [Wild Card](https://lablab.ai/ai-articles/were-growing-with-our-community-new-features-on-lablabai#voting-program) finalist to present his projects and compete for the main prize. We want to give voice to our community and it was an amazing opportunity to do so!
...
If you didn’t know, [the winning project](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon/ai-disruptor/ai-brand-intel) was created by one person - Misbah Syed, who already won the previous Cohere AI Hackathon. And the winner of the **customer review category** won the heart of judges due to its complexity, ready to market and many more! And short information about the app itself:
...
An [amazing project](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon/dragon/legal-ease) was created by team Dragon. The winners of the** legal document category** created a tool to simplify legal documents to common use.
...
Winners of the **internal knowledge base search category **presented a powered by ChatGPT API, Cohere, Qdrant and Whisper [solution](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon/wiki-search/joan-holloway) to “discover the power of of your corporate knowledge”
...
A [solution](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon/savvy-synapses/easefind) provided by team Savvy Synapses won the **recommendations category**, but none of the team members joined the winner announcement stream and had the opportunity to change judges' minds.
...
Amazing [project](https://lablab.ai/ai-hackathons/multilingual-semantic-search-hackathon/abacates-voadores/logos) that stole the heart of our community was from team Abacetes Voadores. An astonishing personal knowledge based assistant!
...
That’s why we want to invite you to the second episode of [Build your AI Startup](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2) Hackathon. A unique Hackathon, which focuses on assisting you to build the best MVP for your product and help you to bring it to the market. Know more [about the first episode](https://lablab.ai/ai-articles/build-your-ai-startup-hackathon-winner-announcement) and join today!
