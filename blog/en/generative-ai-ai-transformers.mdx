...
One good example - **_[Learn visually](https://lablab.ai/ai-hackathons/cohere-ai-hackathon-embed/ThePathForward/Learn%20visually)_**
...
If you want to create a new tool using the newest AI based technology, join our [Hackathons](https://lablab.ai/ai-hackathons) and with help of our mentors create one in 48 hours!

Learn about [stable diffusion models](https://lablab.ai/ai-articles/state-of-the-art-ai-stable-diffusion-models), get familiar with [qdrant apps](https://lablab.ai/apps/tech/qdrant) or [redis apps](https://lablab.ai/apps/tech/redis).
