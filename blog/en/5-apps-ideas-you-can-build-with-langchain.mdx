...
And you can build one during lablab.ai’s [Artificial Intelligence Hackathon](https://lablab.ai/ai-hackathons) and later on, incubate it during an [AI slingshot](https://lablab.ai/blog/giving-voice-to-the-community-new-features-on-lablabai) program in order to turn it into a ready-to-market application!
