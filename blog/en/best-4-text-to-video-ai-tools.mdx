...
We even have a [Stable Diffusion tutorial](https://lablab.ai/ai-tutorials/stable-diffusion-tutorial-how-to-create-video-with-text-prompts) on how to use it!
...
You already can explore [text-to-image](https://lablab.ai/ai-articles/how-to-create-an-image-with-ai-5-top-ai-generative-apps) generation, [text-to-3D](https://lablab.ai/ai-articles/ai-revolution-for-game-industry-best-best-ai-text-and-image-to-3d-generation) generation, [image-to-3D](https://lablab.ai/ai-articles/ai-revolution-for-game-industry-best-best-image-to-3d-ai-tools) generation, or enjoy many perfect [AI tools for scriptwriters](https://lablab.ai/ai-articles/ai-revolution-for-movie-industry-best-ai-tools-for-scriptwriters). So why the AI revolution for the creative industry should stop there?
...
And as you are reading it, you already know, that you can create a creative [AI app](https://lablab.ai/apps) changing the creative industry forever during lablab.ai [AI Hackathons](https://lablab.ai/ai-hackathons).
