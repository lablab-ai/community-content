...
description: "Learn how to build multi-agent AI systems for AI hackathons using IBM watsonx Orchestrate. Technical deep-dive with real hackathon projects, ADK tutorials, and best practices for online AI hackathons."
