...
You can use [Stable Diffusion models](https://lablab.ai/ai-articles/state-of-the-art-ai-stable-diffusion-models) 1.5 and 2.1 inside of it, train your own models or use models trained by Leonardo.ai. Also you have a beta solution in generating textures from text.
...
In the event you can't find the perfect AI tool to suit your needs, consider participating in a [Hackathon Artificial Intelligence](https://lablab.ai/ai-hackathons). These collaborative events offer an ideal environment to develop custom AI solutions tailored to your requirements. By building your own AI tool during a hackathon, you not only address your specific needs but also contribute to the broader creative community by sharing your innovation as a free tool or even turning it into a startup venture.

Join a variety of events, based on the core technology used - [OpenAI Hackathon](https://lablab.ai/ai-hackathons/openai-hackathon), [GPT-3 Hackathon](https://lablab.ai/ai-hackathons/gpt3-online), or the one with the hottest technology out there - [AutoGPT Hackathon](https://lablab.ai/ai-hackathons/autonomous-gpt-agents-hackathon)!
