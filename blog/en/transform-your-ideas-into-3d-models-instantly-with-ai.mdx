...
To get started with 3D AI, join [AI hackathons](https://lablab.ai/ai-hackathons) hosted by lablab.ai. These hands-on events let you collaborate and learn while building innovative 3D projects leveraging the latest AI tools. Participating in the builder community at hackathons is a great way to jumpstart your 3D AI learning.
