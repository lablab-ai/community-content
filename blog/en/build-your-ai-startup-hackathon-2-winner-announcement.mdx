...
Whether you're an [AI21 API](https://lablab.ai/ai-tutorials/how-to-use-ai21labs) fan, an [AutoGPT API](https://lablab.ai/tech/autogpt) devotee, or a [ChatGPT API](https://lablab.ai/tech/openai/chatgpt) enthusiast, this event catered to everyone's preferences. The choice of generative AI model was entirely up to the participants, empowering them to unleash their creativity and bring their unique AI-based applications to life.
...
Picture this: you've just spent 7 days passionately working on a project, and now you're on the brink of turning it into a profitable startup! That's precisely the unique opportunity offered by lablab.ai's Slingshot program, which will incubate and accelerate the winning team's product. Talk about a life-changing experience![Hackathon Artificial Intelligence](https://lablab.ai/ai-hackathons), only from lablab.ai!
...
Extraordinary and unique submission from **we have absolutely no idea** team - [memoiz](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2/we-absolutely-have-no-idea/memoiz). They created an application, which allows you to “look up your brain”. But how does it exactly work?
...
Among the five projects competing for the main prize was [Capita](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2/prometheus-labs/capita) from the Prometheus Labs team. A useful tool for managing your finances.
...
A Saas platform to empower small and medium-sized businesses in Africa has been created by [CreativeWithAI](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2/createwithai/createwiithai) team.
...
Another interesting, and ready-to-go market, app was created by Team Vision. [PrepQuest](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2/team-vision/prepquest) - the ultimate interview preparation app!
...
Last but not least project - [Reelify](https://lablab.ai/ai-hackathons/ai-startup-hackathon-episode-2/reeflify/reeflify) - an AI-driven app to rise awareness about coral reefs and its impact on the environment
