---
title: "Chroma Tutorial with Stable Diffusion: Building Simple Image Generation Gallery App with Semantic Search Capabilities"
description: "How to utilize Chroma database to store generated images as embeddings and retrieve the embeddings by similar terms, built using Python"
...
Chroma is like a playground for these AI models. It facilitates the development of AI-powered applications by providing a platform for storing, querying, and analyzing media embeddings. Media could range from text to images, and in future releases, audio and video.
...
4. Completing the Endpoints Function
5. Test Running the Image Generation App
6. Adding Search By Similar Term Feature
7. Testing the Search Capabilities of the Image Gallery App
...
<Img src="https://iili.io/Hru07UP.png" alt="A terminal prompt showing `(env)` at the start of the line, indicating that the `env` virtual environment is active.">
...
<Img src="https://iili.io/HrviRDb.png" alt="Image gallery showing the images of a unicorn, a mushroom and butterflies">
...
<Img src="https://iili.io/HrvilfV.png" alt="User input 'horse' as search term and the gallery returns a picture of unicorn as first result">
...
<Img src="https://iili.io/HrviVOg.png" alt="The backend's log showing the query results, ordered by cosine-similarity of the prompts with the search term">
