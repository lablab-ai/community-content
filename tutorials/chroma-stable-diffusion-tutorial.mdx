...
[Stable Diffusion](https://stability.ai/stable-diffusion), is a new generative model that can generate high-resolution images with a single forward pass. Check out amazing [Stable Diffusion application](https://lablab.ai/apps/tech/stable-diffusion)!
