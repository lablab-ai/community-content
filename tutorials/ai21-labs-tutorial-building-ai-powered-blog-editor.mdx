...
<Img src="https://iili.io/HPHf1hQ.png" alt="The Blog Editor app" />
...
<Img src="https://iili.io/HPHfcpj.png" alt="We type our sentence: 'The cutthroat business of bug bounty hunting'" />
...
<Img src="https://iili.io/HPHfEQV.png" alt="The generated completion which expands on the first sentence" />
...
<Img src="https://iili.io/HPHfakb.png" alt="We input a grammatically incorrect sentence" />

Now, click the "Fix Grammar" button!

<Img src="https://iili.io/HPHf0Tx.png" alt='The "Fix Grammar" button click replaces the grammatically incorrect sentence with the correct one' />
...
<Img src="https://iili.io/HPHfMCB.png" alt='We input our sentence "While being vegan has its upside, aversion to meat has another risk, which is deficiency of Vitamin B12"' />


Now, click the "Paraphrase" button.

<Img src="https://iili.io/HPHfW41.png" alt='The paraphrased text: "Although being vegan has its benefits, avoiding meat can lead to a risk of Vitamin B12 deficiency."' />
...
<Img src="https://iili.io/HPHfVEP.png" alt="We input the text to be improved" />

Admittedly, the current sentence isn't very well-constructed. To improve it, click the "Improve Text" button.

<Img src="https://iili.io/HPHfh3F.png" alt='The improved text: "I think grapefruit is delicious and awesome."' />
...
<Img src="https://iili.io/HPHfjYg.png" alt='We pasted the link to the HackerOne site' />

Next, click the "Summarize Link" button.

<Img src="https://iili.io/HPHfNyJ.png" alt='The result of the link summarization, displaying a description of HackerOne' />
