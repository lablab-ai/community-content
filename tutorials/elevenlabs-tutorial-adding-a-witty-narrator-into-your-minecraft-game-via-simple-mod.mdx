...
<Img src="https://iili.io/HsOKcBV.png" alt="the user interface of minecraft launcher" />

Let's click the `Installations` tab. This menu should list the various installations of Minecraft in our machine.

<Img src="https://iili.io/HsOK5Ij.png" alt="we create new installation with version 1.12.2" />
...
<Img src="https://iili.io/HsOKuku.png" alt="we go to Minecraft app data directory using Windows' Run" />
...
<Img src="https://iili.io/HsOKAmb.png" alt="we copy the downloaded mods to the mods directory" />
...
<Img src="https://iili.io/HsOK7hx.png" alt="the various scripts inside mcpipy directory, such as helloworld.py which return 'Hello World'! and spawn a diamond ore block, and whereami.py which simply returns the position of player character." />
...
<Img src="https://iili.io/HsOK0rP.png" alt="we choose the forge version and run the game." />
...
<Img src="https://iili.io/HsOKlEB.png" alt='the `/py helloworld command returns "Hello world!" to the console and spawns a diamond ore block under the player character&apos;s feet' />
...
<Img src="https://iili.io/HsOKGYF.png" alt='we test running the narration service, the service responded with the witty and over the top narration, A Stanley Parable-style.' />
...
<Img src="https://iili.io/HsOKOEN.png" alt='we input `/py narrate` command into our Minecraft console' />

After we input the command, let's push `Enter`. The opening message of the mod should show up.

<Img src="https://iili.io/HsOKv2t.png" alt='the opening message of our narrate script shows up along with the position of the character as well as the block ID' />
...
<Img src="https://iili.io/HsOKNBp.png" alt='the narration text should show up after the audio narration finished playing' />
