...
image: "https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/58fc4c11-d4c5-443e-6f07-c1bd89544c00/public"
authorUsername: "stevekimoi"
---

# Native.Builder Tutorial: Build an AI-Powered Onboarding Agent

<LiteYouTube videoId="emjVNBOA1gs" containerClassName={"youtubeContainer"} />
...
<table>
  ...
  <tbody>
    <tr><td><strong>Step 1: Welcome</strong></td><td>Full-screen card with headline, subtext, and a Get Started button</td></tr>
    <tr><td><strong>Step 2: About You</strong></td><td>First name input and four role cards (Developer, Designer, Product Manager, Founder)</td></tr>
    <tr><td><strong>Step 3: Your Goals</strong></td><td>Multi-select goal cards (Ship faster, Reduce costs, Improve collaboration, Automate workflows)</td></tr>
    <tr><td><strong>Step 4: All Set</strong></td><td>Personalized summary with the user's name, role badge, selected goal tags, and three role-specific recommended next steps</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td>Icon library?</td><td>Lucide (clean, minimal)</td><td>Standard in Vite + React, well supported, no missing-dependency errors</td></tr>
    <tr><td>Recommended next steps content?</td><td>I'll write them out now</td><td>Generic placeholders weaken Step 4. Write real content once</td></tr>
    <tr><td>Transition effect?</td><td>Simple fade only</td><td>Slide and scale animations introduce layout bugs; fade is reliable</td></tr>
    <tr><td>Layout?</td><td>Max-width with blur backdrop</td><td>Centered card with dark blurred background matches modern SaaS onboarding patterns</td></tr>
  </tbody>
</table>
