...
This tutorial shows how to create a custom diffusers pipeline for text-guided image-to-image generation with the [Stable Diffusion model](https://lablab.ai/tech/stability-ai/stable-diffusion) using the 🤗 Hugging Face Diffusers library.
...
reading [here](https://lablab.ai/tech/stability-ai/stable-diffusion).
