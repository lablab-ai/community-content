...
response = ai21.Summarize.execute(
    source="https://lablab.ai/ai-hackathons/plug-into-ai-with-ai21",
    sourceType='URL')
...
As you can see, AI21 has a bunch of APIs in its arsenal that can come in handy to solve very specific problems. I think it is worth considering giving them a chance. You'll have the opportunity to do so at an upcoming [event with AI21 Labs](https://lablab.ai/ai-hackathons/plug-into-ai-with-ai21) starting on 28 June. I encourage you to participate!
