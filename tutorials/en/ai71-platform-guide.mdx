...
**Note**: Currently, only `tiiuae/falcon-180b-chat` and `tiiuae/falcon-11b` models are operational. The other models will be available soon. In the meantime, you can test the `tiiuae/falcon-180b-chat` model to get a feel for the platform.
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1721748859/homepage_bgkfit.png" alt="Welcome to AI71 Platform" caption="Explore the Homepoage of AI71 platform" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1721749104/sandbox_ynxfjp.png" alt="AI71 Sandbox" caption="Explore the Sandbox of AI71 platform" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1721749104/documentation_bmwbdv.png" alt="AI71 Documentation" caption="Explore the Sandbox of AI71 platform" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1721749103/org_jxjekh.png" alt="Organization" caption="Create an Organization" />

- Manage API Keys: Create and manage API keys.
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1721749102/API_key_cqj9zm.png" alt="API keys" caption="Create API Key" />
