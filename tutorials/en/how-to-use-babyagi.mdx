...
If you want to test your new skills and create an app based on BabyAGI or try other Autonomous Agents, we invite you to the [LangChain x GPT Agents Hackathon](https://lablab.ai/ai-hackathons/autonomous-gpt-agents-hackathon)!
