...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062815/agentops-init-start_q6o3ca.png" alt="initialize Agentops" caption="Agentops initialized" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062831/select-session_iphhkh.png" alt="session selection" caption="select session" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062828/session-top-section_kmzk0m.png" alt="session overview" caption="session overview" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062820/select-checkpoint_hrhp7r.png" alt="select task" caption="select task/agent" />

<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062816/second-section-left_pgon2t.png" alt="select task" caption="View task metrics"  />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062828/second-section-right_opqwdk.png" alt="LLM chat viewer" caption="LLM chat viewer" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1726062830/session-replay-third-section_nkg4mp.png" alt="LLM call analysis" caption="LLM call analysis" />
