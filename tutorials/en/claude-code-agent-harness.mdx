...
description: "Learn how to build a Claude Agent SDK harness that autonomously finds and fixes bugs in a Python codebase, from zero to a working agent in 30 minutes."
