...
As you can see, implementing this is not that difficult and does not take long, and with the combination of AI21 and LangChain we are able to build really powerful applications. I encourage you to check it out during our [Plug into AI with AI21](https://lablab.ai/ai-hackathons/plug-into-ai-with-ai21) Hackathon! Feel free to join and build with us!
