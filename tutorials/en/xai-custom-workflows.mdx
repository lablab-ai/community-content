...
1. **Run the Application**:
   ...
   <Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1733921635/streamlit-start_t8mjh2.png" alt="streamlit running" caption="Application running locally" />
...
3. **Outputs**:
   ...
   - After uploading an image, you will see a preview of the uploaded image:
     <Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1733921635/image-upload_rcfmxg.png" alt="upload image to the workflow" caption="Upload image to the workflow" />

   - The application will process the image and extract the text, as shown here:
     <Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1733921635/extract-text_ozuwzi.png" alt="Extracted Text" caption="Get the extracted text from the image" />

   - The summarized version of the extracted text will appear in this section:
     <Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1733921635/get-summary_zt8odd.png" alt="Summarized Text" caption="Get the summary of the extracted text" />

   - Finally, actionable insights will be generated and displayed:
     <Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1733921635/get-insights_ud0g3f.png" alt="Actionable insights" caption="Actionable insights from summary" />
