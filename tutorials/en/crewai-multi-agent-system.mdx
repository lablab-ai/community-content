...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781262/begin_ez412z.png" alt="Begin First Task" caption="First Task starting" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781262/error-failover_wbcqcd.png" alt="Using custom tool" caption="Custom Tool in use" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781267/finish-retrival_h9hbsu.png" alt="Data Retrieval Response" caption="Data Retrieval Final Response" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781273/support_start_ht8134.png" alt="Support Agent" caption="Support Agent working" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781272/qa-agent_sur7hl.png" alt="Suport QA Agent" caption="Support QA Agent working" />

Then QA agent receives the feedback from the Support Agent and now seeks our feedback for a better response if need be.

<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781263/feedback_tpn3u8.png" alt="Feedback from QA Agent" caption="Feedback from QA Agent" />

The QA agent then receives the feedback and works on its response based on what was said and gives a suitable response.

<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781274/final-answer-qa_ofemuw.png" alt="Final Answer from QA Agent" caption="Final Answer from QA Agent" />
...
<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781257/output-file_nlepgk.png" alt="Locate Output file" caption="Locate the Output file" />

The content of the output file holds the final response from the Support QA agent.

<Img src="https://res.cloudinary.com/dqvd8otcz/image/upload/v1724781265/final-response_xcvruq.png" alt="Content of Output file" caption="Content of Output file" />
