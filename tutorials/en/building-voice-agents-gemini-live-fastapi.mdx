...
description: "Build a production-ready voice agent backend using Gemini 2.5 Live API's native audio streaming, four streaming async tasks, and Gemini function-calling for deterministic structured outputs. Sub-second latency, graceful interruptions, zero JSON parsing headaches."
