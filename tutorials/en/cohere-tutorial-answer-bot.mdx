...
But the journey doesn't stop there. Join our AI Hackathons to put your knowledge to the test and build AI-based tools that can change the world. With the guidance of our mentors, you can be part of the AI revolution. Check out our upcoming [AI hackathons](https://lablab.ai/ai-hackathons).
