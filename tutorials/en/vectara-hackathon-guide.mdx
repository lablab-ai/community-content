...
| --------------- | -------------------- |
| **API Docs**    | [Documentation](https://docs.vectara.com/docs/) |
| **API Playground** | [REST API Playground](https://docs.vectara.com/docs/rest-api/) |
| **Getting Help**    | Join our [Discord Server](https://discord.gg/GFb8gMz6UH) or visit our [Discussion Forum](https://discuss.vectara.com/) if you have questions. If you have any feedback for us, we would be glad to hear it - please let us know in the forums or our Discord channel. |
| **Open Source Projects** | 1. **Data Ingestion:** [Vectara Ingest on GitHub](https://github.com/vectara/vectara-ingest) helps with crawling data sources and indexing them into Vectara. 2. **UI for Q&A:** [Vectara Answer on GitHub](https://github.com/vectara/vectara-answer) demonstrates a UI concept for question answering. |
...
- **Sample applications:** 
  - [Check out sample applications](https://vectara.com/demos/)
  
- **Blog posts:**
  - [A Reference Architecture for Grounded Generation](https://vectara.com/a-reference-architecture-for-grounded-generation/)
  - [Vector Search: What is Vector Search and How Does it Work?](https://vectara.com/vector-search-what-is-vector-search-and-how-does-it-work/)
  - [Grounded Generation Done Right: Chunking](https://vectara.com/grounded-generation-done-right-chunking/)
  - [Grounded Generation: Making Generative AI Safe, Trustworthy & More Relevant](https://vectara.com/grounded-generation-making-generative-ai-safe-trustworthy-more-relevant/)
  
- **Youtube:**
  - [Flowise + Vectara](https://youtu.be/OJK-jdFYn6I)
  - [Ask LangChain Docs](https://youtu.be/ACQaSAJxoBs)
  - [More Videos](https://www.youtube.com/channel/UCoP_hcyjJRLQr0CV050bfMg)
  
- **Integrations:**
  - [LangChain: Better Together](https://blog.langchain.dev/langchain-vectara-better-together/)
  - [LlamaIndex + Vectara](https://vectara.com/llamaindex-vectara/)
  
- **Startup program:**
  - [Vectara Startup Program](https://vectara.com/startups)
