---
title: 'Building an Autonomous Wallet Agent: AI-Powered Smart Wallets That Execute Transactions'
description: 'Learn how to build an AI agent that autonomously manages a blockchain wallet, executes transactions, and purchases items from a marketplace using natural language commands. This tutorial covers Circle Developer-Controlled Wallets, Groq AI, LangChain.js, and building a complete chat interface.'
image: ''
...
**How it works**: We are using the https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/scripts/createWalletSet.ts & https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/scripts/createWallets.ts
...
![Application frontend interface](https://res.cloudinary.com/dygkv9gam/image/upload/v1767081614/UI_u0pywt.png)
...
1. **Groq Model Initialization** - Creates the LLM instance:
   ...
   ```
   Check on this line https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/3174315c15e38c7b09e1cdd627591cc9fcbd96af/backend/src/agent/agent.ts#L23 
...
2. **System Prompt** - Defines the agent's behavior and capabilities. The prompt instructs the agent to:
   ...
   Check out the lines https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/3174315c15e38c7b09e1cdd627591cc9fcbd96af/backend/src/agent/agent.ts#L38-L86
...
3. **Message Processing Loop** - The core agent loop:
   ...
   Check out the lines https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/agent.ts#L92-L229

**The Agent Loop in Action:**

When you say "Buy me 'The Art of Programming'", the agent:
1. Recognizes purchase intent
2. Calls `browse_ebooks` to find the book - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L13-L41 
3. Calls `check_wallet_balance` to verify funds - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L11-L38
4. Calls `purchase_ebook` to execute the purchase - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L107-L142 
...
- **`check_wallet_balance`** - Checks USDC balance and returns token ID needed for transfers - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L11-L38 
- **`get_wallet_info`** - Gets wallet details including address - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L40-L68 
- **`list_transactions`** - Lists transaction history with optional filters - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L70-L109 
- **`get_transaction`** - Gets specific transaction details - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L111-L146 
- **`transfer_tokens`** - Transfers USDC to another address - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/wallet.tools.ts#L148-L205 
...
- **`browse_ebooks`** - Lists all available e-books - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L13-L41 
- **`search_ebooks`** - Searches e-books by title/author - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L43-L73 
- **`get_ebook_price`** - Gets price for a specific e-book - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L75-L105 
- **`purchase_ebook`** - Executes purchase by transferring USDC - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/agent/tools/marketplace.tools.ts#L107-L142 
...
**Functions:**
- `getAllEbooks()` - Returns all e-books - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/marketplace/catalog.ts#L173-L178 
- `findEbookById(id)` - Finds specific e-book - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/marketplace/catalog.ts#L180-L185 
- `searchEbooks(query)` - Searches by title/author - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/backend/src/marketplace/catalog.ts#L187-L199 
...
- Frontend sends POST request to `/api/chat` with message - https://github.com/Stephen-Kimoi/wallet-intergrated-ai/blob/main/frontend/src/components/ChatInterface.tsx#L32-L72 
