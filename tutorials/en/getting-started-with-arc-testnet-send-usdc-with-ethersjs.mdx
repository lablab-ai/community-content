---
title: "Getting Started with Arc Testnet: Send USDC with ethers.js for AI Hackathons"
description: "Learn how to connect to Circle's Arc blockchain testnet and send USDC transactions using ethers.js for AI hackathons. This guide covers wallet setup, reading balances, and executing programmatic transfers on Arc's USDC-native network, perfect for blockchain AI hackathon projects."
image: "https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/8fb8875b-7996-4453-31f4-c93feb312000/full"
...
This makes Arc an excellent platform for **AI hackathons**, especially those focusing on FinTech, blockchain, or decentralized applications. Understanding how to interact with Arc programmatically can be a valuable skill for your **AI hackathon projects**, enabling efficient and cost-effective transactions. Whether you're participating in **online AI hackathons** or **virtual AI hackathons**, this knowledge can give you a competitive edge. If you're looking for **upcoming AI hackathons** to apply these skills, explore [LabLab.ai's global AI hackathons](https://lablab.ai/ai-hackathons).
...
Want to learn more about Arc's architecture? Check out the [Arc blockchain documentation on lablab.ai](https://lablab.ai/tech/arc).
...
- **Arc blockchain**: [lablab.ai/tech/circle/arc](hhttps://lablab.ai/tech/arc) - Technical docs and use cases
...
Now that you've built a working Arc integration, explore more [Circle technologies](https://lablab.ai/tech/circle) and [Arc blockchain documentation on lablab.ai](https://lablab.ai/tech/arc) to build sophisticated financial applications.
