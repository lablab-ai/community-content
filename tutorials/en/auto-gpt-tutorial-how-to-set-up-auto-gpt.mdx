...
And if you want to test your new skills and create an app based on AutoGPT, we invite you to the [AutoGPT Hackathon](https://lablab.ai/ai-tutorials/autogpt-tutorial-how-to-set-up-your-own-ai-bot-in-under-30-minutes)!
