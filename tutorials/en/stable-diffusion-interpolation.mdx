...
[Stable diffusion](https://lablab.ai/tech/stability-ai/stable-diffusion) is Open Source latent text-to-image diffusion model. You can find out more [here](https://lablab.ai/tech/stability-ai/stable-diffusion) or try it by yourself - code is available [here](https://github.com/CompVis/stable-diffusion).
