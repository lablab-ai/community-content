...
A [ChatGPT plugin](https://lablab.ai/ai-articles/chatgpt-update-chatgpt-plugins-are-out) is an add-on software developed to integrate external applications into ChatGPT's
