...
a URL (inspired by <a href="https://lablab.ai/ai-tutorials/streamlit-deploy-tutorial">this lablab tutorial</a>). We will then feed Audiocraft with this 
...
by uploading the code to Github and following the rest of the <a href="https://lablab.ai/ai-tutorials/streamlit-deploy-tutorial">Streamlit deploy tutorial</a>.
