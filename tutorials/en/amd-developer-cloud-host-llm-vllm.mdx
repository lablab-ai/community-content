...
# Host Your First LLM on an AMD GPU: A Developer's Guide to AMD Developer Cloud and vLLM
...
1. Go to [amd.com/en/developer/ai-dev-program.html](https://www.amd.com/en/developer/ai-dev-program.html)
