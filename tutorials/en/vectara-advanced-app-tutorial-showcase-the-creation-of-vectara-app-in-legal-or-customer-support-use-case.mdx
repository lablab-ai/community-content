...
<Img src="https://iili.io/JftkvZQ.md.png" alt="Navigate to Vectara Dashboard" caption="Navigate to the Vectara Dashboard by signing in and accessing the data panel." />

2. **Enter Your Data Store Details**
<Img src="https://iili.io/JftvvJn.md.png" alt="Data Panel" caption="Enter the required details for your data store." />

3. **Add Data to Your Corpus**
<Img src="https://iili.io/Jft8Tgt.md.png" alt="Add Data Page" caption="Add data manually or use the provided code to populate your corpus." />

4. **Generate an API Key in the Access Control Tab**
<Img src="https://iili.io/Jft8W7e.md.png" alt="Control Access Tab" caption="Create a new API key through the access control tab." />

5. **Create and Configure Your API Key**
<Img src="https://iili.io/Jft88rP.md.png" alt="API Key Creation" caption="Fill in the details to generate a new API key for Query and Index Services." />

6. **Securely Store the API Key**
<Img src="https://iili.io/JftSHTG.md.png" alt="API Key" caption="Copy and store your new API key in your .env file." />

7. **Retrieve Corpus and Customer IDs**
<Img src="https://iili.io/JftSBa9.md.png" alt="Corpus ID" caption="Copy your corpus and customer IDs for integration." />

8. **Obtain the Authentication URL**
<Img src="https://iili.io/JftSYa1.md.png" alt="Auth URL" caption="Copy the necessary authentication endpoint." />

9. **Get the App Client ID**
<Img src="https://iili.io/JftUyXf.md.png" alt="App Client ID" caption="Document the App Client ID for your records." />

10. **Acquire the App Client Secret**
<Img src="https://iili.io/Jftgb3B.md.png" alt="Client Secret" caption="Securely add the client secret to your .env file." />
...
<Img 
  src="https://iili.io/Jftsd1j.md.png" 
...
<Img 
  src="https://iili.io/JftsA2R.md.png" 
...
<Img 
  src="https://iili.io/JftsG4f.md.png" 
  alt="Document Indexing"
/>
...
<Img 
  src="https://iili.io/JftQvdx.md.png" 
  alt="Document Indexing"
/>
