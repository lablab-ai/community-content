...
[Stable Diffusion](https://lablab.ai/tech/stability-ai/stable-diffusion) is a text-to-image latent diffusion model created by the researchers and engineers from CompVis, Stability AI and LAION. It's trained on 512x512 images from a subset of the LAION-5B database.
