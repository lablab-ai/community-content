...
## Step 1: Setting up Your Hostinger Instance and Installing OpenClaw
...
## Step 2: Setting Up Your Messaging Channels

Navigate to **Docker Manager** > **Projects** > **Terminal**.
![Docker projects manager section](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738040/dgurvyltumwvyphczpal.png)

![Docker terminal chat section](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738042/vrih5xzglljqqxmplyqx.png)
...
![Onboarding terminal getting started](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738045/gie1petanouszgrb7trw.png)
...
![Onboarding model provider selection](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738048/fabiphadsfdtascq1gws.png)

Then select *Gemini API Key*
![Onboarding google auth provider](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738050/iwurmcokjxgyebiqmexo.png)
...
![Model Choosing](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738053/g0evqcpjen7e2zqpytok.png)
...
![Telegram bot setup](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738056/ihpwos12bgtykkgrhmlf.png)
...
![Set up wallet prompt](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738058/ssak8f9r71izyjunutp7.png)

This is the expected response, as wallet creation may take some time.

![Expected Response](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738060/ufm51yhxesqv71fhz2vb.png)

Once it is done, this is the response that you'll see

![Final response](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738063/df7k8tqzrwibdnilipwk.png)

**Step 2: Obtaining USDC Test Funds**
...
![Funds Deposited Confirmation](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738066/zhezmd0wkepjiecnsvkw.png)

**Step 3: Testing a Transaction**
...
![receive base sepolia USDC](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738068/mhbkycv0qq5oohuvksgm.png)
...
![Expected output](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738070/gcy09sdbks3hwsclo1rj.png)

And you can also confirm it in the [Block Explorer](https://sepolia-explorer.base.org)

![Block explorer confirmation](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738073/fpyhdjc6d8h4qjaxospc.png)
...
### Part 3: Creating a Wallet on Solana
...
![Solana wallet](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738076/yzlek8uoyhls6uyzny2h.png)

**Step 2: Obtaining USDC/SOL Test Funds**
...
![Solana Devnet funds receive](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738078/ou3vdhakf7rclzzrgkix.png)
...
![Solana Deposit Confirmed](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738081/evkdzhgnkuyqwlfli9z8.png)
...
![Phantom Wallet Receive](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738085/i6tbzf6n66uluygratsh.png)
...
![SOL Sent Succesfully](https://res.cloudinary.com/dygkv9gam/image/upload/v1770738093/ufnz2ccnntxgo3jze55q.png)
