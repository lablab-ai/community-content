...
Last but not least, [you could easily deploy this app by uploading it to Github and connecting the repository to the Streamlit platform](https://lablab.ai/ai-tutorials/streamlit-deploy-tutorial).
