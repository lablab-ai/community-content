---
title: "GPT 3.5 tutorial: How to use new chatbot built in bing"
description: "A tutorial how to use new Bing’s GPT-3.5 announced on 7/02/2023."
image: "https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/9726e3a3-18f9-49c2-9279-298f93120400/full"
authorUsername: "Marek"
---

## What is Bing’s new chatbot?

On 7th of February 2023, Microsoft announced that it’s going to include in the newest version of [Bing search](https://blogs.microsoft.com/blog/2023/02/07/reinventing-search-with-a-new-ai-powered-microsoft-bing-and-edge-your-copilot-for-the-web/?fbclid=IwAR3YUUZJv6wKhNow2MXfeOhrTTVztYGQGa-Pi3WyxJ4sZKJhyUIeGx9bHOE) a chatbot. As you can read in the article, the AI included in Bing search is a LLM that “is more powerful than ChatGPT and customized specifically for search. It takes key learnings and advancements from ChatGPT and GPT-3.5 – and it is even faster, more accurate and more capable.”
...
It also does a good job in writing blog articles. As always, we encourage you to always fact check and proofread as ChatBots, even ChatGPT or future new chatbot, as the [hallucinations](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)) sometimes might occur.
