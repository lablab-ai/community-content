...
By the end of this [AI tutorial](https://lablab.ai/t), you'll know [how to use EasyOCR](https://lablab.ai/ai-tutorials/tech/easyocr) for text extraction from various sources like photos, and harnessing the power of OpenAI's [GPT-3](https://lablab.ai/tech/openai/gpt3) for text summarization!
...
I will use image from [Adrian's](https://www.linkedin.com/in/adrian-banachowicz/) previous [tutorial](https://lablab.ai/ai-tutorials/esrgan):
