...
1. **Navigate to Vultr Dashboard**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/45cfbc29-22cd-4843-ede1-e1b324a13e00/public" alt="Deploy a server" caption="Deploy a server"/>
...
7. **Deploy Server**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/f5476f1d-58da-4fc7-aaf1-c1bb88a8f800/public" alt="Deploy a server configuration" caption="Deploy a server configuration"/>
...
2. Copy the **IP Address** and **Password** (if not using SSH keys)
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/1796adfe-a74c-4efa-a9d1-f7501a6e4e00/public" alt="Server Dashboard" caption="Server Dashboard"/>
...
2. **Go to Extensions**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/95651dad-6ea3-4d33-0c76-bcb7406ac500/public" alt="Docker MindsDB Install" caption="Docker MindsDB Install"/>
...
1. **Welcome Screen**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/0ff9ef7e-22b0-44d7-6ed4-4c1920630300/public" alt="MindsDB Welcome" caption="MindsDB Welcome"/>

2. **Connect Data Source**
   Click **"Create & Continue"** (we'll connect our actual database in a moment)

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/143b9f1f-2cb9-4f68-883a-975144ed4c00/public" alt="MindsDB Connect Datasource" caption="MindsDB Connect Datasource"/>

3. **Create Agent Tutorial**
   Click **"Create & Continue"**

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/3b0ee38a-738c-4888-1a9a-620ca3b57500/public" alt="MindsDB Create an Agent Steps" caption="MindsDB Create an Agent Steps"/>

4. **Setup Complete**
   You'll see the main MindsDB interface

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/4a69c505-1f4b-4b0b-f074-d9a53e4e6a00/public" alt="Finish setup MindsDB" caption="Finish setup MindsDB"/>
...
1. **Open SQL Editor**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/63833e00-4107-45c6-a98b-cdf8334bff00/public" alt="MindsDB SQL editor" caption="MindsDB SQL editor"/>

2. **Run the Hello World Example**
   You'll see a pre-loaded "Hello World" tutorial. Click the green **"RUN"** button to execute it.

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/12c9acf2-24a7-4c14-5a9c-ea61baa86600/public" alt="MindsDB hello world" caption="MindsDB hello world"/>
...
1. **Navigate to Chat Interface**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/aee5d835-708c-420b-e1df-e42a51027300/public" alt="MindsDB chat with my data sidebar" caption="MindsDB chat with your data sidebar"/>

2. **Try the Agent**
   You'll see a chat interface where you can interact with the agent you just created

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/5377a539-8873-4877-1867-4b09452abf00/public" alt="MindsDB chat with data" caption="MindsDB chat with data"/>
...
2. **Select PostgreSQL**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/29ada476-503e-4f5d-6baa-de157428e300/public" alt="MindsDB select postgres" caption="MindsDB select postgres"/>

3. **Enter Database Credentials**
   Fill in the connection details (same as your `.env` file):

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/8c2ee575-0665-4b86-8879-01dcf5836e00/public" alt="MindsDB set up postgres" caption="MindsDB set up postgres"/>
...
2. **Create New Tab**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/5564cd0d-8f57-4091-8484-903bcd1a4800/public" alt="MindsDB select new datasource" caption="MindsDB select new datasource"/>

   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/b3577aaa-1986-4885-200c-f0bf7f19c100/public" alt="MindsDB new datasource" caption="MindsDB new datasource"/>
...
2. **Create New Agent**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/2c2e084d-938f-45b2-bf65-f9c875ef8000/public" alt="MindsDB Create an Agent" caption="MindsDB Create an Agent"/>
...
2. **Select Your Agent**
   ...
   <Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/d29d511e-64f4-43f1-b566-adeae4d11d00/public" alt="MindsDB select agent" caption="MindsDB select agent"/>
