...
We will use the ChatGPT API (gpt-3.5-turbo) in combination with Langchain to create a response to our questions. If you want to dive deep and learn more about how to integrate the [ChatGPT API](https://lablab.ai/ai-tutorials/chatgpt-tutorial-how-to-integrate-chatgpt-and-whisper-api-into-your-project) to your other projects, we have dedicated tutorials for this.
...
And if you want to give your new skills a spin and build an amazing app with cutting edge technology and assistance from our mentors, [join our AI Hackathons and build the future with AI](https://lablab.ai/ai-hackathons).
