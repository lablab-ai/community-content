---
title: "Anthropic Claude + LangChain Tutorial: How to create Anthropic Claude + LangChain with React and FastAPI"
description: "In this tutorial we will build a Anthropic’s Claude powered website. We will use Anthropic’s Claude API, React, Tailwind CSS and Axios. I'll be using the Anthropic’s Claude LangChain library. You may also use instead of Anthropic’s Claude API, either Python SDK or TypeScript/JavaScript SDK."
image: "image"
...
<Img src="./images/" alt="AI generated art by Midjourney" caption="AI generated art by Midjourney"/>

In this tutorial we will build a Anthropic’s Claude powered website. We will use [Anthropic’s Claude API](https://console.anthropic.com/docs), [React](https://react.dev/), [Tailwind CSS](https://tailwindcss.com/) and [Axios](https://axios-http.com/docs/intro). I'll be using the [Anthropic's Claude LangChain library](https://python.langchain.com/en/latest/_modules/langchain/llms/anthropic.html). You may also use instead of Anthropic’s Claude API, either [Python SDK](https://console.anthropic.com/docs/api/libraries#python) or [TypeScript/JavaScript SDK](https://console.anthropic.com/docs/api/libraries#typescript).
...
Now go to `http://127.0.0.1:8000/docs` you will see the automatic interactive API documentation (provided by [Swagger UI](https://swagger.io/)). Click try it out and type `ex: What is a good name for a company that makes colorful socks`. You should see something similar to:
...
Let's try to chat with the AI!

<Img src="./images/chatWithAIPreview.png" alt="Chat with AI" caption="Chat with AI"/>
