...
description: "In this tutorial, I will show you guys how to use Chroma DB and Cohere embeddings to alive the personas from books using Stable Diffusion high-resolution image generation model. Sit back, relax and enjoy the tutorial!"
image: ""
...
<Img src="./images/cohereDashboard.png" alt="Cohere Dashboard" caption="Cohere Dashboard"/>
