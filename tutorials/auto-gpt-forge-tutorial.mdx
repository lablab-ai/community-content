...
<Img src="https://iili.io/JHEGdxI.png" alt="Create new agent" caption="Create a new agent with Forge" />
...
<Img src="https://iili.io/JHEGKfn.png" alt="Set environment" caption="Set OpenAI Api Key in .env file" />
...
<Img src="https://iili.io/JHEG3iX.png" alt="Running an agent" caption="Running an agent" />


This command runs the server on http://0.0.0.0:8000 and watches for changes.


<Img src="https://iili.io/JHEGHDN.png" alt="Agent running" caption="Agent running on http://0.0.0.0:8000" />
...
<Img src="https://iili.io/JHEG2Vt.png" alt="Auto-GPT user interface" caption="Auto-GPT Flutter interface" />
...
<Img src="https://iili.io/JHEGfls.png" alt="Auto-GPT Benchmark" caption="Testing the agent's performance" />
