---
title: "Anthropic's Claude and LangChain Tutorial: Bulding Personal Assistant App"
description: "How to utilize LangChain and using Anthropic's Claude model on top of it, to create Personal Assistant AI App, built with Python and ReactJS"
...
3. **Add environment variables**: Open the `.env` file in your favorite code editor and add your environment variables. Each variable should be on a new line, in the format KEY=VALUE:
   ...
   ```text
   # API KEY for your Anthropic API service
   ANTHROPIC_API_KEY=sk-ant-xxxxxxxxxxxxxxxxx
   # API KEY for SerpAPI service
   SERPAPI_API_KEY=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ```
   As the .env file suggest, you need to have both API key for [Anthropic Claude](https://console.anthropic.com/chat) model and [SerpAPI service](https://serpapi.com), which we'll use for making web search.
...
<Img src="https://iili.io/H6pv0MJ.png" alt="the output of flask run command, showing the server running on localhost and port 5000" />
...
<Img src="https://iili.io/H6pv16v.png" alt="the result of the /ask endpoint. The answer is incorrect, which it answers with 'Breath of the Wild 2'" />
...
<Img src="https://iili.io/H6pvGFR.png" alt="the result of the /search endpoint to our question, what is the sequel of Zelda: Breath of the Wild?" />


This time, it worked nicely! How does it work under the hood? let's look at the output in our terminal.

<Img src="https://iili.io/H6pvMap.png" alt="The AI agent at work, it started the 'chain' by forming a thought, considering using web search to support its answer. After that, it made the observation that the sequel of Breath of The Wild is indeed Tears of the Kingdom" />
...
<Img src="https://iili.io/H6pvV8N.png" alt="the /search endpoint responded incorrectly, it seemed that it didn't remember the context of the previous conversation" />
...
<Img src="https://iili.io/H6pvjwX.png" alt="the /ask endpoint responded correctly, saying that we asked it about the sequel of Zelda: Breath of the Wild" />
...
<Img src="https://iili.io/H6pvX9I.png" alt="The UI of our assistant app" />
...
<Img src="https://iili.io/H6pvhut.png" alt="The assistant app is thinking..." />

Give it a few seconds to think...

<Img src="https://iili.io/H6pvwtn.png" alt="The AI answered incorrectly, saying that it is Yakuza: Like A Dragon which doesn't feature Kiryu" />
...
<Img src="https://iili.io/H6pvOns.png" alt="The request took longer, but was answered correctly" />
...
<Img src="https://iili.io/H6pveMG.png" alt="The thought process of the AI: it decided to make a web search using the term &quot;upcoming Yakuza games&quot; and observed the result" />
