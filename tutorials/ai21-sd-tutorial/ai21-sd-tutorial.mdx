...
To use AI21 Labs Studio we need API Key. Go to AI21 Labs Studio, [Sign up](https://studio.ai21.com/) for an account to be taken to your API Key. [Click me](https://studio.ai21.com/account) once you have created an account to be taken to your API Key. Click `API Key` on the left sidebar and copy/save it.

To use Stable Diffusion we need API Key. Go to Dream Studio, [Sign up](https://dreamstudio.ai/) for an account to be taken to your API Key. [Click me](https://dreamstudio.ai/account) once you have created an account to be taken to your API Key. Click to `Profile picture` on the top right corner and click `API Key` to copy/save it.
...
Firstly, let's create a file named `stable_diffusion.py` and implement function to generate image from text using Stable Diffusion model:
...
Finally, let's create a file named `app.py` and implement our Streamlit app. 
...
Checkout this tutorial on how to deploy your app to Streamlit Sharing Cloud: [Deploying Streamlit Apps to Streamlit Sharing](https://lablab.ai/t/elevenlabs-langchain-tutorial-how-to-create-custom-podcast-generator-streamlit-app)
