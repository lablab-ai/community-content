...
description: "in this tutorial, we will build a personal finance advisor app using the Chroma + Cohere API"
authorUseername: "Youknowsthevibes"
---
...
The core API is only 4 functions (run  💡 Google Colab or Replit template):
