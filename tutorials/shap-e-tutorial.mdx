...
<Img src="https://www.dropbox.com/s/yrhecal8dqx84jz/colabNewNotebook.png?dl=0" alt="Creating new Notebook in Google Colab" caption="Creating new Notebook in Google Colab"/>
