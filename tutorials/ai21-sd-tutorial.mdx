...
```
It's time to implement main functions for generating `ideas`:
...
At last, We need to add requirement.txt file in our app folder. Run this command in terminal. It will add requirement file in your code base which is very important for python projects.
