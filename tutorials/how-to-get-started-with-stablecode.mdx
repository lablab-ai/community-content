...
image: "https://storage.googleapis.com/lablab-static-eu/images/tutorials/stablecodetut.png"
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/25579e48-b191-445b-b038-4e4a8d24a000/full" alt="Creating new Notebook in Google Colab" caption="Creating new Notebook in Google Colab"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/496e3acd-1baa-45c0-50e8-2e884b620c00/full" alt="Google Colab runtime" caption="Google Colab runtime"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/d26d5c45-a0a5-4468-6850-d6f924c0dd00/---
title: "StableCode Tutorial: How to get started with StableCode"
description: "Brief explanations of key concepts and step-by-step guide to get started with StableCode"
image: ""
authorUsername: "abdibrokhim"
...
made with 💜 by [abdibrokhim](https://linkedin.com/in/abdibrokhim) for [lablab.ai tutorials](https://lablab.ai/t)." alt="Loading base model" caption="Loading base model"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/424f3791-91ca-4256-041b-c26498bea800/full" alt="Completion by StableCode" caption="Completion by StableCode"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/d26d5c45-a0a5-4468-6850-d6f924c0dd00/full" alt="Loading base model" caption="Loading base model"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/19e8632e-e5a9-468c-9dab-f43be3f3fe00/full" alt="Binary search in a given list by StableCode" caption="Binary search in a given list by StableCode"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/6e4dcc00-8d85-48bf-d280-9ef8f1a77300/full" alt="Completion by StableCode" caption="Completion by StableCode"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/67d88657-f823-4094-6516-397e9955ec00/full" alt="Create an account in Hugging Face " caption="Create an account in Hugging Face"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/31cdf0e3-b151-465f-416a-8999ab2cea00/full" alt="Create a new token" caption="Create a new token"/>

Give your token a name, from dropdown select `read` and hit `Generate a token`.

<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/06c02c9b-65c0-4fff-b62f-4018003cf800/full" alt="Create a new token" caption="Create a new token"/>
...
<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/4ad74dcb-80f2-4d38-28ba-5d651b322500/full" alt="Run with Hugging Face Inference API" caption="Run with Hugging Face Inference API"/>

Then from dropdown select `Inference API`. It will open a dialog with code snippet, just hit the `Copy`.

<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/877a9511-d82f-402a-142a-b6ed62376400/full" alt="Run with Hugging Face Inference API" caption="Run with Hugging Face Inference API"/>

<Img src="https://imagedelivery.net/K11gkZF3xaVyYzFESMdWIQ/7d361fd8-3d83-4564-c9a2-f2c751d2e500/full" alt="Run with Hugging Face Inference API" caption="Run with Hugging Face Inference API"/>
