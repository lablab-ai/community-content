---
title: "AI Agents tutorial: How to use and create AI Agents & Tools?"
description: "Have you heard of AI Agents? It's worth learning about their capabilities, how you can use them, add to them and create tools for them!"
image: ""
...
Let's start by creating new directory and initializing Python environment.
...
Simple as that! Now let's create a tool for solving math problems. We will create custom class for this. There are many APIs created by [Wolfram Alpha](https://www.wolframalpha.com/), but I will use one of simplest.
