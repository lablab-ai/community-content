...
description: "This tutorial will teach you how to create a conversational AI agent using LangChain and Monday.com API that can add items to your Monday.com board by simply sending a message to the agent."
image: ""
