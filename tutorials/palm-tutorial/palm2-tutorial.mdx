...
description: "In this tutorial, we will learn how to build AI-powered Virtual Assistant using Google's PaLM2 model. Sit back relax, and let the AI do the work for you."
image: ""
...
<Img src="./images/preview.png" alt="Streamlit preview" caption="Streamlit preview"/>

Perfect! Now, let's deploy our app on Streamlit Sharing Cloud. Checkout [this tutorial](put link to elevenlabs and langchain tutorial that i created before it has detailed guide) for detailed guide to deploy your app on Streamlit Sharing Cloud.
