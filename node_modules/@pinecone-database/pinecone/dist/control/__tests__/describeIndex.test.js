...
describe('describeIndex', function () {
    var responseData;
    var setupSuccessResponse = function () {
        return {
            describeIndex: jest
                .fn()
                .mockImplementation(function () { return Promise.resolve(responseData); }),
        };
    };
    beforeEach(function () {
    ...
    test('should remove undefined fields from response', function () { return __awaiter(void 0, void 0, void 0, function () {
        var IOA, returned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    IOA = setupSuccessResponse();
    ...
    describe('argument validation', function () {
        test('should throw if index name is not provided', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                expectToThrow = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, describeIndex_1.describeIndex)(IOA)()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                }); }); };
                expect(expectToThrow).rejects.toThrowError(errors_1.PineconeArgumentError);
                expect(expectToThrow).rejects.toThrowError('The argument to describeIndex had type errors: argument must be string.');
                return [2 /*return*/];
            });
        }); });
        ...
        test('should throw if index name is empty string', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                expect(expectToThrow).rejects.toThrowError(errors_1.PineconeArgumentError);
                expect(expectToThrow).rejects.toThrowError('The argument to describeIndex had validation errors: argument must not be blank.');
                return [2 /*return*/];
            });
        }); });
    });
