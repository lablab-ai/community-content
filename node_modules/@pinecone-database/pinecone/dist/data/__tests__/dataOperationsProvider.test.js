...
jest.mock('../../pinecone-generated-ts-fetch', function () { return (__assign(__assign({}, jest.requireActual('../../pinecone-generated-ts-fetch')), { Configuration: jest.fn() })); });
describe('DataOperationsProvider', function () {
    ...
    test('makes no API calls on instantiation', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            new dataOperationsProvider_1.DataOperationsProvider(config, 'index-name');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    provider = new dataOperationsProvider_1.DataOperationsProvider(config, 'index-name');
                    expect(indexHostSingleton_1.IndexHostSingleton.getHostUrl).not.toHaveBeenCalled();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    provider = new dataOperationsProvider_1.DataOperationsProvider(config, 'index-name', indexHostUrl);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    provider = new dataOperationsProvider_1.DataOperationsProvider(config, 'index-name', undefined, additionalHeaders);
                    return [4 /*yield*/, provider.provide()];
                case 1:
                    _a.sent();
                    expect(pinecone_generated_ts_fetch_1.Configuration).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=dataOperationsProvider.test.js.map