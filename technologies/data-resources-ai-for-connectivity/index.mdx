---
title: "Resource Guide for AI for Connectivity Hackathon"
description: "Resource Guide for AI for Connectivity Hackathon"
---
...
## **Table of Contents**
1. [Datasets](#datasets)
   - [Connectivity and Network Infrastructure](#connectivity-and-network-infrastructure)
   - [Geospatial Data](#geospatial-data)
   - [Internet Measurement Data](#internet-measurement-data)
   ...
   - [Additional Network Modeling and Simulation Datasets](#additional-network-modeling-and-simulation-datasets)
2. [Simulators and Tools](#simulators-and-tools)
3. [Collections and Resources](#collections-and-resources)
...
- **Source**: Giga
- **Documentation Link**: [Giga School Mapping](https://maps.giga.global/map)
- **Data Access Link**: [Data Access](https://unicef-my.sharepoint.com/:f:/g/personal/riraj_unicef_org/En1M0PWJItNDoAOirEv8uzoBogM9LeCnIxKV7MTaTL2Vyw?e=WQzaTZ)
...
- **Link**: [Internet Exchange Map](https://www.internetexchangemap.com/)

#### **1.7 Submarine Cable Map**
- **Description**: Visualizes submarine cable networks globally, maintained by TeleGeography.
- **Source**: TeleGeography
- **Link**: [Submarine Cable Map](https://www.submarinecablemap.com/)
...
- **Link**: [Sentinel-2 Data](https://scihub.copernicus.eu/)
...
- **Link**: [Google Open Buildings](https://sites.research.google/open-buildings/)
...
- Link: [Earth Engine Data Catalog](https://developers.google.com/earth-engine/datasets)
...
- Link: [POIs Data](https://overturemaps.org/)
...
- Source: World Bank
- Link: [World Bank Data Catalog](https://datacatalog.worldbank.org/search/dataset/0038055)

#### **2.8 Microsoft Global Building Footprints**
- Description: Worldwide building footprint data derived from satellite imagery.
- Source: Microsoft
- Link: Microsoft [Building Footprints](https://github.com/microsoft/GlobalMLBuildingFootprints)
...
- **Source**: OONI
- **Link**: [OONI Explorer](https://ooni.org/support/ooni-explorer/)

#### **3.2 Ookla Speedtest**
- **Description**: Global dataset of download and upload speeds, and latency for broadband and mobile networks.
- **Source**: Ookla
- **Link**: [Ookla Speedtest Data](https://registry.opendata.aws/speedtest-global-performance/)
...
- **Source**: IODA
- **Link**: [IODA API](https://api.ioda.inetintel.cc.gatech.edu/v2/)
...
- **Source**: UNDP
- **Link**: [HDI Data](http://hdr.undp.org/en/data)
...
- **Link**: [Relative Wealth Index](https://dataforgood.facebook.com/dfg/tools/relative-wealth-index#accessdata)
...
- **Source**: HealthSites
- **Link**: [Health Center Locations](https://healthsites.io/)
...
- **Source**: BNN-UPC
- **Link**: [Network Modeling Datasets](https://github.com/BNN-UPC/NetworkModelingDatasets)
...
- **Source**: Hugging Face
- **Link**: [5GNetworkOptimization](https://huggingface.co/datasets/infinite-dataset-hub/5GNetworkOptimization)
---

## **2. Simulators and Tools**

### **BNNetSimulator**
- **Description**: A packet-level network simulator built on OMNeT++ for generating datasets.
- **Features**:
  - Traffic profiles (Poisson, CBR, ON-OFF).
  - Performance metrics (delay, jitter, packet loss).
- **Resources**:
  - [Quickstart Notebook](https://github.com/BNN-UPC/BNNetSimulator/blob/main/quickstart.ipynb)
  - [Input Parameters Glossary](https://github.com/BNN-UPC/BNNetSimulator/blob/main/input_parameters_glossary.ipynb)
- **Docker Image**: [BNNetSimulator Docker](https://hub.docker.com/r/bnnupc/bnnetsimulator)
- **GitHub**: [BNNetSimulator Repository](https://github.com/BNN-UPC/BNNetSimulator)
...
- **Link**: [OsmoBTS](https://osmocom.org/projects/osmobts/wiki)
...
- **Link**: [OpenBTS](https://github.com/RangeNetworks/openbts)
...
- **Link**: [Magma](https://magmacore.org/)
...
### **Awesome-Telco**
- **Description**: 
  A curated and comprehensive list of telecom-related tools, resources, and projects that span multiple aspects of telecommunication technologies. This repository is designed for researchers, developers, and enthusiasts working on telco systems and includes a rich variety of tools and frameworks for:
  - **SIM Management**:
...
- **Link**: [Awesome-Telco](https://github.com/ravens/awesome-telco)

---

### **Awesome-Connectivity**
- **Description**: 
  A detailed repository maintained by **Steve Song**, focusing on connectivity-related resources. This collection provides insights into the infrastructure, access, and connectivity status across different regions, helping users understand who has access to communication networks and on what terms. Key highlights include:
  - **Connectivity Maps**:
...
- **Link**: [Awesome-Connectivity](https://github.com/stevesong/awesome-connectivity-info)
